...
SocialCalc.Callbacks.ToggleCell = function()
{
	...
	//cmdstr = "set "+ cellname + ' text t <div onclick="SocialCalc.Callbacks.ToggleCell();"><img src="http://www.ftsign.com/images/checkmark__16_black_T.png"></img></div>' + "\n";
	cmdstr = "set "+ cellname + ' text t <div onclick="SocialCalc.Callbacks.ToggleCell();">&#10004</div>' + "\n";	
	
    } else {
	// set the value to a space
	cmdstr = "set " + cellname + ' text t <div onclick="SocialCalc.Callbacks.ToggleCell();">&nbsp;</div>' + "\n";
    }
